...
:SAMUCREST => {
	:ID => 1039,
	:name => "Samurott Crest",
	:desc => "Gains Fighting-type STAB and resistances. Slicing moves are boosted by 50%.",
	:price => 0,
	:crest => true,
	:noUseInBattle => true,
	:noUse => true,
...
:ZOROCREST => {
	:ID => 1091,
	:name => "Zoroark Crest",
	:desc => "While under Illusion, grants the ability and STABs of the copied Pokemon to both Unovan and Hisuian Zoroark.",
	:crest => true,
	:noUseInBattle => true,
	:noUse => true,
},

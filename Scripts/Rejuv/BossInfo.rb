...
##############################
    ...
    :BELIAL => {
        ...
        :onBreakEffects => { # in order of shield count, with the highest value being the first shield broken and the lowest the last
            1 => {
                :threshold => 0, # if desired, shield can be broken at higher hp% than 0
                :message => "Belial is in its last stand!", # message that plays when shield is broken
                :bosssideChanges => :Safeguard,
                :bosssideChangeCount => 5,
    ...
    :RIFTCARNIVINE => {
        :name => "Rift Carnivine",
        :entryText => "Rift Carnivine is dancing the samba!",
        :shieldCount => 2,
        :immunities => {},
        :moninfo => {
            :species => :CARNIVINE,
        ...
        :onBreakEffects => {
            2 => {
                ...
                :bossEffectMessage => "Rift Carnivine did the robot and became Steel-type!",
            ...
            1 => {
                ...
                :message => "The rhythm of the music has changed!",
                :bossEffectMessage => "Rift Carnivine did the jitterbug and became Bug-type!",
        ...
        :sosDetails =>  { # pokemon details
            ...
            :moninfos => {
                1 => {
                    ...
                    :form => 0,
                    :item => :LIGHTCLAY,
                    :moves => [:GRASSKNOT,:HELPINGHAND,:PSYSHOCK,:LIGHTSCREEN],
                    :ability => :NATURALCURE,
                    :nature => :TIMID,
                    :iv => 31,
                    :happiness => 255,
        ...
        :sosDetails =>  { # pokemon details
            ...
            :moninfos => {
                1 => {
                    :species => :CHARIZARD,
                    :level => 45,
                    :moves => [:FLAMETHROWER,:AIRSLASH,:DRAGONBREATH,:ROOST],
                    :ability => :BLAZE,
                    :shiny => true,
                    :nature => :TIMID,
                },
                2 => {
                    ...
                    :level => 45,
                    :item => :CHARIZARDITEX,
                    :moves => [:BULLDOZE,:DRAGONBREATH,:FLAMETHROWER,:AIRSLASH],
                    :ability => :BLAZE,
                    :shiny => true,
                    :nature => :BRAVE,
                },

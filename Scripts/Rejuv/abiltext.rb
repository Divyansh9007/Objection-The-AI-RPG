...
:AFTERMATH => {
	...
	:fullDesc => "When reduced to 0 HP by a contact move, the attack suffers 1/4th of its max HP. Damp prevents this effect."
},
...
:INEXORABLE => {
	...
	:fullDesc => "Dragon-type moves deal 50% more damage against foes slower than this Pokémon."
},
